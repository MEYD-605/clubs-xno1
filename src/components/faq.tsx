...
const faqData = [
    {
        ...
        answer: "เราส่งรูปด่วนภายใน 24 ชม. (วันถัดไป) หลังจบงานครับ ไม่ต้องรอนานเป็นเดือนเหมือนที่อื่นแน่นอน",
        icon: <Clock className="w-5 h-5" />
    },
    {
        question: "มีการแต่งรูป หรือรีทัชหน้าเนียนให้ไหม?",
        answer: "เราปรับแสงสี (Color Grading) ให้พรีเมียมทุกใบ และรีทัชใบหน้า (หน้าเนียน/เรียว) ให้เป็นธรรมชาติทุกใบในเซ็ตครับ ตั้งใจทำให้คุณดูดีที่สุดในทุกใบ",
    ...
    },
    {
        ...
        answer: "แนะนำให้พักผ่อนให้เพียงพอ เตรียมชุดที่มั่นใจที่สุดมาสัก 2-3 ชุดครับ ถ้าไม่แน่ใจเรื่อง Vibe ทักมาปรึกษาผมก่อนได้ฟรีครับ ผมจะไกด์ให้จนกริบ!",
