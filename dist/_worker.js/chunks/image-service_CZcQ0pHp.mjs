...
import { i as isRemotePath, j as joinPaths } from './path_CH3auf61.mjs';
import { b as baseService, i as isESMImportedImage } from './generic_w6xbsvA_.mjs';
import { aC as commonjsGlobal } from './astro/server_ACK6epuL.mjs';
import require$$0 from 'node:crypto';
import { a as matchHostname, m as matchPattern } from './remote_Bcm9Fvtc.mjs';
...
const service = {
  ...
  getURL: (options, imageConfig) => {
    ...
    const imageEndpoint = joinPaths(
      ...
      Object.assign(__vite_import_meta_env__, { _: process.env._ }).BASE_URL,
      "/cdn-cgi/image",
      resizingParams.join(","),
      imageSource
    );
