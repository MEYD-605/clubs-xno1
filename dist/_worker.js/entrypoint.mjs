...
import { g as getActionQueryString, a as astroCalledServerError, A as ActionError, d as deserializeActionResult, b as ACTION_QUERY_PARAMS, c as appendForwardSlash } from './chunks/astro-designed-error-pages_jNz6whnz.mjs';
import { o as objectType, s as stringType } from './chunks/astro/server_ACK6epuL.mjs';
import { d as defineAction } from './chunks/index_BbtJIgd8.mjs';
...
const server = {
  contact: defineAction({
    ...
    input: objectType({
      ...
      contact: stringType().min(5, "Contact info must be at least 5 characters"),
